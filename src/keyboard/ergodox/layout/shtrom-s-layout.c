...
KB_MATRIX_LAYER(
	...
	KEY_LeftControl,	KEY_LeftGUI,	KEY_LeftAlt,	KEY_LeftArrow,	KEY_RightArrow,	
	KEY_LeftBracket_LeftBrace,	2,	
	0,	0,	KEY_Home,	
	KEY_Spacebar,	KEY_Dash_Underscore,	KEY_End,	
	// right hand
	KEY_Escape,	KEY_6_Caret,	KEY_7_Ampersand,	KEY_8_Asterisk,	KEY_9_LeftParenthesis,	KEY_0_RightParenthesis,	0,	
	...
	KEY_ReturnEnter,	KEY_n_N,	KEY_m_M,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_Slash_Question,	KEY_RightShift,	
	KEY_UpArrow,	KEY_DownArrow,	KEY_RightAlt,	KEY_RightGUI,	KEY_RightControl,	
...
KB_MATRIX_LAYER(
	...
	0,	0,	0,	KEY_VolumeDown,	KEY_VolumeUp,	
	0,	1,	
	0,	0,	0,	
	0,	0,	0,	
	// right hand
...
KB_MATRIX_LAYER(
	...
	KEYPAD_0_Insert,	KEYPAD_Period_Delete,	0,	0,	0,	
	2,	0,	
	0,	0,	0,	
	0,	0,	0	
),
...
KB_MATRIX_LAYER(
	...
	kprrel,	NULL,	ktrans,	ktrans,	ktrans,	
	lpop1,	ktrans,	
	ktrans,	NULL,	NULL,	
	ktrans,	ktrans,	ktrans	
),
...
KB_MATRIX_LAYER(
	...
	NULL,	NULL,	kprrel,	NULL,	kprrel,	NULL,	
	ktrans,	NULL,	kprrel,	kprrel,	kprrel,	NULL,	ktrans,	
	ktrans,	ktrans,	ktrans,	kprrel,	kprrel,	
	ktrans,	lpop2,	
	NULL,	NULL,	ktrans,	
